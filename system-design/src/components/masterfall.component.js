...
render() {
  ...
  <h2 style={{ color: 'navy', position: 'absolute', top: '285%', left: '20%', btm: '200%'}}>Master Class List:</h2>   
  <h6 style={{ color: 'black', position: 'absolute', top: '295%', left: '1%', btm: '200%'}}><List bulleted>
  <div>
